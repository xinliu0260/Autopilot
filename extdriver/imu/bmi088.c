...
static rt_err_t gyroscope_init(void)
{
    ...
    rt_thread_mdelay(35000);              // > 30ms delay
                         ...
                         const char* gyro_device_name, const char* accel_device_name, uint32_t dev_id)
{
    ...
    RT_TRY(dev_gyro_register(&gyro_dev, gyro_device_name, RT_DEVICE_FLAG_RDWR, (void*)dev_id));
    ...
    RT_TRY(dev_accel_register(&accel_dev, accel_device_name, RT_DEVICE_FLAG_RDWR, (void*)dev_id));
