...
typedef struct {
    ...
    rt_bool_t got_posllh;
    rt_bool_t got_velned;
    rt_bool_t got_svinfo;
    rt_bool_t configured;
    rt_bool_t use_nav_pvt;
} ubx_decoder_t;

void reset_ubx_decoder(ubx_decoder_t* ubx_decoder);
rt_err_t init_ubx_decoder(ubx_decoder_t* ubx_decoder, rt_device_t ubx_dev, ubx_rx_handle_ptr ubx_rx_handle);
int parse_ubx_char(ubx_decoder_t* ubx_decoder, const uint8_t c);

rt_err_t send_ubx_msg(ubx_decoder_t* ubx_decoder, const uint16_t msg, const uint8_t* payload, const uint16_t length);
rt_err_t configure_ubx_msg_rate(ubx_decoder_t* ubx_decoder, const uint16_t msg, const uint8_t rate);
