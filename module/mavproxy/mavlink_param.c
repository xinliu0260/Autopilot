...
static mav_param_list_t mavlink_param = {
    ...
    MAVLINK_PARAM_DEFINE(RC_MAP_ROLL, 4),
    MAVLINK_PARAM_DEFINE(RC_MAP_PITCH, 2),
    MAVLINK_PARAM_DEFINE(RC_MAP_YAW, 1),
	...
	MAVLINK_PARAM_DEFINE(BAT1_A_PER_V,-1),   //float ADC��ѹ�˸�ϵ���ĵ�ص��� -1:board default
	MAVLINK_PARAM_DEFINE(BAT1_CAPACITY,10000),  //float ������� [-1 100000] mAh
	MAVLINK_PARAM_DEFINE(BAT1_I_CHANNEL,-1), //int32 ����ADCͨ�� -1:board default
	MAVLINK_PARAM_DEFINE(BAT1_N_CELLS,4),   //int32 ���о��
	MAVLINK_PARAM_DEFINE(BAT1_R_INTERNAL,-1),//float ÿ�ڵ������
	MAVLINK_PARAM_DEFINE(BAT1_SOURCE,0),		//int32 ��ؼ��Դ�� -1���� 0��Դģ�� 1�ⲿ��ϵͳԤ���յ�mavlink���״̬��Ϣ
	MAVLINK_PARAM_DEFINE(BAT1_V_CHANNEL,-1),	//int32 ��ѹADCͨ�� -1:board default
	MAVLINK_PARAM_DEFINE(BAT1_V_CHARGED,4.2),	//float ȫ��ص�ѹ 4.05V
	MAVLINK_PARAM_DEFINE(BAT1_V_DIV,-1),		//float ��ط�ѹ�� -1��board default
    MAVLINK_PARAM_DEFINE(BAT1_V_EMPTY,3.7),	//float �յ�ص�ѹ 3.6
	MAVLINK_PARAM_DEFINE(BAT1_V_LOAD_DROP,0.1),//float ������ʱ�ĵ��ѹ�� V
    MAVLINK_PARAM_DEFINE(BAT_AVRG_CURRENT,0),//float �����е�Ԥ�ڵ�ص��� ���Ʒ���ʣ��ʱ���RTL����
    MAVLINK_PARAM_DEFINE(BAT_CRIT_THR,0.07),	//float �����ٽ���ֵ �ᴥ��RTL
    MAVLINK_PARAM_DEFINE(BAT_EMERGEN_THR,0.05),	//float ����������ֵ �ᴥ��landing
	MAVLINK_PARAM_DEFINE(BAT_LOW_THR,0.15),  	//float ��������ֵ �����͵�������
	MAVLINK_PARAM_DEFINE(BAT_V_OFFS_CURR,0),	//float ����������ADC�ķ���ƫ��
...
rt_err_t send_mavparam_by_name(char* name)
{
...
rt_err_t send_mavparam_by_index(int16_t index)
{
...
rt_err_t mavlink_param_set(const char* name, float val, uint8_t mav_param_type)
{
    rt_err_t err;
    param_t* param;
    int8_t i8val;
...
rt_err_t mavlink_param_send(const param_t* param)
{
    mavlink_message_t msg;
