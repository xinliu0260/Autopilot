...
typedef struct {
    ...
    MAVLINK_PARAM_DECLARE(BAT1_A_PER_V);   //float ADC��ѹ�˸�ϵ���ĵ�ص��� -1:board default
	MAVLINK_PARAM_DECLARE(BAT1_CAPACITY);  //float ������� [-1 100000] mAh
	MAVLINK_PARAM_DECLARE(BAT1_I_CHANNEL); //int32 ����ADCͨ�� -1:board default
	MAVLINK_PARAM_DECLARE(BAT1_N_CELLS);   //int32 ���о��
	MAVLINK_PARAM_DECLARE(BAT1_R_INTERNAL);//float ÿ�ڵ������
	MAVLINK_PARAM_DECLARE(BAT1_SOURCE);		//int32 ��ؼ��Դ�� -1���� 0��Դģ�� 1�ⲿ��ϵͳԤ���յ�mavlink���״̬��Ϣ
	MAVLINK_PARAM_DECLARE(BAT1_V_CHANNEL);	//int32 ��ѹADCͨ�� -1:board default
	MAVLINK_PARAM_DECLARE(BAT1_V_CHARGED);	//float ȫ��ص�ѹ 4.05V
	MAVLINK_PARAM_DECLARE(BAT1_V_DIV);		//float ��ط�ѹ�� -1��board default
    MAVLINK_PARAM_DECLARE(BAT1_V_EMPTY);	//float �յ�ص�ѹ 3.6
	MAVLINK_PARAM_DECLARE(BAT1_V_LOAD_DROP);//float ������ʱ�ĵ��ѹ�� V
	
    MAVLINK_PARAM_DECLARE(BAT_AVRG_CURRENT);//float �����е�Ԥ�ڵ�ص��� ���Ʒ���ʣ��ʱ���RTL����
    MAVLINK_PARAM_DECLARE(BAT_CRIT_THR);	//float �����ٽ���ֵ �ᴥ��RTL
    MAVLINK_PARAM_DECLARE(BAT_EMERGEN_THR);	//float ����������ֵ �ᴥ��landing
	MAVLINK_PARAM_DECLARE(BAT_LOW_THR);  	//float ��������ֵ �����͵�������
	MAVLINK_PARAM_DECLARE(BAT_V_OFFS_CURR);	//float ����������ADC�ķ���ƫ��
