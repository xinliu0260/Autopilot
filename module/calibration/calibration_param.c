...
//	PARAM_INT32(BAT1_N_CELLS,4,false),   //int32 ���о��
//	PARAM_FLOAT(BAT1_V_CHARGED,4.2,false),	//float ȫ��ص�ѹ 4.05V
//    PARAM_FLOAT(BAT1_V_EMPTY,3.7,false),	//float �յ�ص�ѹ 3.6
//    PARAM_FLOAT(BAT1_V_DIV, 1.0, false),
//    PARAM_UINT8(BAT1_N_CELLS, 4, false),
    /* Board Rotation */
