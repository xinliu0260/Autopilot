...
static void init_parameter(void)
{
    ...
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_AIRSPEED_TRIM), &CONTROL_PARAM.FW_AIRSPEED_TRIM));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_FF), &CONTROL_PARAM.FW_FF));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_FF_LIMIT), &CONTROL_PARAM.FW_FF_LIMIT));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_PI_LIMIT), &CONTROL_PARAM.FW_PI_LIMIT));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_ROLL_EFFC), &CONTROL_PARAM.FW_ROLL_EFFC));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_PITCH_EFFC), &CONTROL_PARAM.FW_PITCH_EFFC));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_YAW_EFFC), &CONTROL_PARAM.FW_YAW_EFFC));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_PITCH_OFFSET), &CONTROL_PARAM.FW_PITCH_OFFSET));

    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_PITCH_F), &CONTROL_PARAM.FW_TECS_PITCH_F));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_THOR_FF), &CONTROL_PARAM.FW_TECS_THOR_FF));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_PITCH_P), &CONTROL_PARAM.FW_TECS_PITCH_P));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_THOR_P), &CONTROL_PARAM.FW_TECS_THOR_P));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_PITCH_I), &CONTROL_PARAM.FW_TECS_PITCH_I));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_PITCH_I_LIM), &CONTROL_PARAM.FW_TECS_PITCH_I_LIM));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_THOR_I), &CONTROL_PARAM.FW_TECS_THOR_I));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_PITCH_D), &CONTROL_PARAM.FW_TECS_PITCH_D));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_THOR_D), &CONTROL_PARAM.FW_TECS_THOR_D));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_RATIO), &CONTROL_PARAM.FW_TECS_RATIO));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_W2T), &CONTROL_PARAM.FW_TECS_W2T));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_U2T), &CONTROL_PARAM.FW_TECS_U2T));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_W2P), &CONTROL_PARAM.FW_TECS_W2P));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_U2P), &CONTROL_PARAM.FW_TECS_U2P));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_R2P), &CONTROL_PARAM.FW_TECS_R2P));
    RT_CHECK(param_link_variable(PARAM_GET(CONTROL, FW_TECS_R2T), &CONTROL_PARAM.FW_TECS_R2T));
}
