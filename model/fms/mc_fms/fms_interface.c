...
static void init_parameter(void)
{
    ...
    RT_CHECK(param_link_variable(PARAM_GET(FMS, VEL_XY_LIM), &FMS_PARAM.VEL_XY_LIM));
    ...
    RT_CHECK(param_link_variable(PARAM_GET(FMS, CRUISE_ACC), &FMS_PARAM.CRUISE_ACC));
    RT_CHECK(param_link_variable(PARAM_GET(FMS, TAKEOFF_H), &FMS_PARAM.TAKEOFF_H));
    RT_CHECK(param_link_variable(PARAM_GET(FMS, TAKEOFF_SPEED), &FMS_PARAM.TAKEOFF_SPEED));
    RT_CHECK(param_link_variable(PARAM_GET(FMS, ACCEPT_R), &FMS_PARAM.ACCEPT_R));
    RT_CHECK(param_link_variable(PARAM_GET(FMS, ASSIST_LAND_H), &FMS_PARAM.ASSIST_LAND_H));
    RT_CHECK(param_link_variable(PARAM_GET(FMS, LAND_SPEED), &FMS_PARAM.LAND_SPEED));
    ...
    RT_CHECK(param_link_variable(PARAM_GET(FMS, LAND_LOCK_THRO), &FMS_PARAM.LAND_LOCK_THRO));
}
