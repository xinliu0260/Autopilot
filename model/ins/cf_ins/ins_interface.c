...
static int ins_output_echo(void* param)
{
    ...
    console_printf("sensor status, imu1:%d imu2:%d mag:%d baro:%d gps:%d rf:%d optflow:%d\n",
...
{
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_HOR_Q_BIAS), &INS_PARAM.GPS_HOR_Q_BIAS));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_HOR_Q_SCALE), &INS_PARAM.GPS_HOR_Q_SCALE));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_VER_Q_BIAS), &INS_PARAM.GPS_VER_Q_BIAS));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_VER_Q_SCALE), &INS_PARAM.GPS_VER_Q_SCALE));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_VEL_Q_BIAS), &INS_PARAM.GPS_VEL_Q_BIAS));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_VEL_Q_SCALE), &INS_PARAM.GPS_VEL_Q_SCALE));
    RT_CHECK(param_link_variable(PARAM_GET(INS, ATT_GAIN), &INS_PARAM.ATT_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, HEADING_GAIN), &INS_PARAM.HEADING_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, MAG_GAIN), &INS_PARAM.MAG_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, MAG_AIR_EN), &INS_PARAM.MAG_AIR_EN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, BIAS_G_GAIN), &INS_PARAM.BIAS_G_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_POS_GAIN), &INS_PARAM.GPS_POS_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_ALT_GAIN), &INS_PARAM.GPS_ALT_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_VEL_GAIN), &INS_PARAM.GPS_VEL_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_BIAS_A_GAIN), &INS_PARAM.GPS_BIAS_A_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_POS_DELAY), &INS_PARAM.GPS_POS_DELAY));
    RT_CHECK(param_link_variable(PARAM_GET(INS, GPS_VEL_DELAY), &INS_PARAM.GPS_VEL_DELAY));
    RT_CHECK(param_link_variable(PARAM_GET(INS, RTK_POS_GAIN), &INS_PARAM.RTK_POS_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, RTK_ALT_GAIN), &INS_PARAM.RTK_ALT_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, RTK_VEL_GAIN), &INS_PARAM.RTK_VEL_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, RTK_BIAS_A_GAIN), &INS_PARAM.RTK_BIAS_A_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, OPF_VEL_GAIN), &INS_PARAM.OPF_VEL_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, OPF_BIAS_A_GAIN), &INS_PARAM.OPF_BIAS_A_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, OPF_VEL_DELAY), &INS_PARAM.OPF_VEL_DELAY));
    RT_CHECK(param_link_variable(PARAM_GET(INS, OPF_FIX_GAIN), &INS_PARAM.OPF_FIX_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, BARO_H_GAIN), &INS_PARAM.BARO_H_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, BARO_VZ_GAIN), &INS_PARAM.BARO_VZ_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, BARO_BIAS_AZ_GAIN), &INS_PARAM.BARO_BIAS_AZ_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, BARO_H_DELAY), &INS_PARAM.BARO_H_DELAY));
    RT_CHECK(param_link_variable(PARAM_GET(INS, RF_H_GAIN), &INS_PARAM.RF_H_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, RF_VZ_GAIN), &INS_PARAM.RF_VZ_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, RF_BIAS_AZ_GAIN), &INS_PARAM.RF_BIAS_AZ_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, RF_H_DELAY), &INS_PARAM.RF_H_DELAY));
    RT_CHECK(param_link_variable(PARAM_GET(INS, EXTPOS_POS_GAIN), &INS_PARAM.EXTPOS_POS_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, EXTPOS_VEL_GAIN), &INS_PARAM.EXTPOS_VEL_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, EXTPOS_BIAS_A_GAIN), &INS_PARAM.EXTPOS_BIAS_A_GAIN));
    RT_CHECK(param_link_variable(PARAM_GET(INS, EXTPOS_POS_DELAY), &INS_PARAM.EXTPOS_POS_DELAY));
    RT_CHECK(param_link_variable(PARAM_GET(INS, EXTPOS_PSI_MODE), &INS_PARAM.EXTPOS_PSI_MODE));
    RT_CHECK(param_link_variable(PARAM_GET(INS, EXTPOS_PSI), &INS_PARAM.EXTPOS_PSI));
}
...
void ins_interface_step(uint32_t timestamp)
{
	...
	if(imu_data_updated||mag_data_updated||baro_data_updated||gps_data_updated||rf_data_updated||optflow_data_updated||airspeed_data_updated||ext_pos_data_updated){
		/* run INS */
		INS_step();	
	}
...
void ins_interface_init(void)
{
    ...
    RT_ASSERT(AirSpeed_ID >= 0);
    RT_ASSERT(ExtPos_ID >= 0);
