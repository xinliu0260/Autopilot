...
static rt_err_t handle_mavlink_message(mavlink_message_t* msg, mavlink_system_t this_system)
{
    ...
    case MAVLINK_MSG_ID_SET_ATTITUDE_TARGET:
        if (this_system.sysid == mavlink_msg_set_attitude_target_get_target_system(msg)) {
            ...
            auto_cmd.timestamp = rt_tick_get_millisecond();
        ...
        if (this_system.sysid == mavlink_msg_request_data_stream_get_target_system(msg)) {
            ...
            for (i = 0; i < sizeof(mav_msg_cb_table) / sizeof(msg_pack_cb_table); i++) {
                if (req_data_stream.req_stream_id == mav_msg_cb_table[i].msgid) {
                    if (mavproxy_register_period_msg(MAVPROXY_OBC_CHAN, mav_msg_cb_table[i].msgid, req_data_stream.req_message_rate, mav_msg_cb_table[i].msg_pack_cb, req_data_stream.start_stop) == RT_EOK) {
    ...
    case MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE: {
        ...
        ext_pos_report.timestamp = rt_tick_get_millisecond();
    ...
    case MAVLINK_MSG_ID_HIL_SENSOR: {
        ...
        baro_data.timestamp_ms = rt_tick_get_millisecond();
    ...
    case MAVLINK_MSG_ID_HIL_GPS: {
        ...
        gps_data.timestamp_ms = rt_tick_get_millisecond();
...
rt_err_t mavobc_init(void)
{
    ...
    RT_TRY(mavproxy_register_period_msg(MAVPROXY_OBC_CHAN, MAVLINK_MSG_ID_HEARTBEAT, 1, mavlink_msg_heartbeat_pack_func, true));

    /* register obc mavlink handler */
    RT_TRY(mavproxy_monitor_register_handler(MAVPROXY_OBC_CHAN, handle_mavlink_message));
